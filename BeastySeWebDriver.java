/* setVariableTextToScreenText.java
*       Summary:        Store text of targeted element in variable
*
*       This syntax will retrieve text from targeted element
*       of software web application page and will store it in
*       variable = dropdown.
*
...
import org.IntelligentSigma.selenium.pageObjects.STPConPage;
import org.apache.log4j.Logger;
...
public class ApplicationHelper extends BaseSeleniumPage {
  ...
  /**
   * updatePageObject
   * This is a shortcut (easy read) for updating Page Objects
   *
   * @param page is the Page Object to be Updated
   */
  public void updatePageObject(Object page) {
    PageFactory.initElements(getDriver(), page);
  }

  /**
   * gotoSTPCon
   * This is the GOTO method to take the user to the STPCon Page
   *
   * @param stpConPage is the STPCon Page Object
   * @param url is the destination URL for testing
   * @throws Exception in case there is a malformed url exception
   */
  public void gotoSTPCon(STPConPage stpConPage, String url) throws Exception {
    launchURL(driver, url);
    updatePageObject(stpConPage);
  }

  /**
   * Alternative
   */
  public STPConPage gotoSTPCon(String url) throws Exception {
    launchURL(driver, url);
    return PageFactory.initElements(driver, STPConPage.class);
  }
}
